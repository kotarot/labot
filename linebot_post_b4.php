<?php
require_once(__DIR__ . 'linebot.config.php');
...
function api_post_request($path, $post) {
    ...
    $headers = array(
        ...
        'X-Line-ChannelID: {' . LINEBOT_CHANNEL_ID . '}',
        'X-Line-ChannelSecret: {' . LINEBOT_CHANNEL_SECRET . '}',
        'X-Line-Trusted-User-With-ACL: {' . LINEBOT_MID . '}'
    );
